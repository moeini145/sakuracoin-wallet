...
public class Constants
{
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "sakuracoin-wallet-keys" + FILENAME_NETWORK_SUFFIX;
	...
	public static final String MIMETYPE_TRANSACTION = "application/x-sakuratx";

	public static final int MAX_NUM_CONFIRMATIONS = 3;
	public static final String USER_AGENT = "Sakuracoin Wallet";
	...
	public static final String CURRENCY_CODE_BTC = "SKR";
	public static final String CURRENCY_CODE_MBTC = "mSKR";
